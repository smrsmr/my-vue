    ...
    <div class="fever-d">
      <div class="fever-d-img" v-for="item in msg">
        ...
        <div class="fever-title">
          ...
          <h5 class="pull-left">时间（地区）：{{item.pubdates[0]}} / {{item.pubdates[1]}}</h5>
...
<script>
  export default {
    ...
    created: function () {
      var _this = this
      let url = "/api/top250?apikey=0b2bdeda43b5688921839c8ecb20399b&city='广州'&count=30";
